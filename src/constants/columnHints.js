...
export const SALE_SKU_KEYS = ['商品', '商家编码-商品维度', '商家编码-规格维度', 'SKU货号', '货号', 'skuID', '商品id', 'spuID'];
export const SALE_STATUS_KEYS = ['订单状态', '状态', '售后状态'];
export const SALE_ORDER_ID_KEYS = ['订单号', '子订单号', '订单ID', '订单id'];

export const PURCHASE_SKU_KEYS = ['商品', '商品编码', 'SKU货号', '货号', 'skuID', '商品id', 'spuID', '商家编码-商品维度', '商家编码-规格维度'];
